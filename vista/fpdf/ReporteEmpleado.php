...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(42, 10, utf8_decode('APELLIDO'), 1, 0, 'C', 1);
...
$consulta_reporte_usuario = $conexion->query("SELECT empleado.nombre, empleado.apellido, empleado.dni, cargo.nombre as 'cargo' FROM empleado INNER JOIN cargo ON empleado.cargo = cargo.id_cargo;
");
...
$pdf->Cell(42, 10, utf8_decode($datos_reporte->nombre), 1, 0, 'C', 0);
$pdf->Cell(42, 10, utf8_decode($datos_reporte->apellido), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode($datos_reporte->dni), 1, 0, 'C', 0);
$pdf->Cell(50, 10, utf8_decode($datos_reporte->cargo), 1, 1, 'C', 0);
}
