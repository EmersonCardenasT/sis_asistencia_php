...
<div class="page-content">
    ...
    <div class="text-right mb-3">
        <a href="fpdf/ReporteUsuario.php" target="_blank" class="btn btn-success"><font-awesome-icon :icon="['fas', 'file-pdf']" />Generar Reportes</a>
    </div>
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    <div class="fl-flex-label mb-4 px-2 col-12">
                                        <input type="hidden" placeholder="ID" class="input input__text" name="txtid" value="<?= $datos->id_usuario; ?>">
                                    </div>
                                    <div class="fl-flex-label mb-4 px-2 col-12">
