...
<div class="page-content">
    ...
    $sql = $conexion->query("SELECT asistencia.id_asistencia, 
        ...
        empleado ON asistencia.id_empleado = empleado.id_empleado INNER JOIN cargo ON empleado.cargo = cargo.id_cargo");
    ?>

    <div class="text-right mb-3">
        <a href="fpdf/ReporteAsistencia.php" target="_blank" class="btn btn-success"><font-awesome-icon :icon="['fas', 'file-pdf']" />Generar Reportes</a>
    </div>
