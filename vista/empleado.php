...
<div class="page-content">
    ...
    $sql = $conexion->query("SELECT empleado.id_empleado, empleado.nombre, 
    empleado.apellido, empleado.dni, empleado.cargo, cargo.nombre as 'nom_cargo' 
    FROM empleado INNER JOIN cargo ON empleado.cargo = cargo.id_cargo;");

    ?>

    <div class="text-right mb-3">
        <a href="fpdf/ReporteEmpleado.php" target="_blank" class="btn btn-success"><font-awesome-icon :icon="['fas', 'file-pdf']" />Generar Reportes</a>
    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    ...
                                    <input type="hidden" placeholder="ID" class="input input__text" name="txtid" value="<?= $datos->id_empleado; ?>">
                                    ...
                                    <div class="text-right p-2">
                                        ...
                                        <button type="submit" value="ok" name="btn-modificar" class="btn btn-primary btn-rounded">Modificar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
