...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      // $this->Cell(180);  // mover a la derecha
      // $this->SetFont('Arial', 'B', 10);
      // $this->Cell(85, 10, utf8_decode("Sucursal : ". $dato_info->ubicacion), 0, 0, '', 0);
      // $this->Ln(10);
      ...
      $this->Cell(85, 10, utf8_decode('ENTRADA'), 1, 0, 'C', 1);
...
$consulta_reporte_asistencia = $conexion->query(" SELECT asistencia.entrada, asistencia.salida, empleado.nombre, empleado.apellido, empleado.dni, cargo.nombre as 'cargo' FROM asistencia INNER JOIN empleado ON asistencia.id_empleado = empleado.id_empleado INNER JOIN cargo ON empleado.cargo = cargo.id_cargo; ");
...
$pdf->Cell(40, 10, utf8_decode($datos_reporte->dni), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode($datos_reporte->cargo), 1, 0, 'C', 0);
$pdf->Cell(85, 10, utf8_decode($datos_reporte->entrada), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode($datos_reporte->salida), 1, 1, 'C', 0);
}
